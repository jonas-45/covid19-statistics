        ...
        <Card className="text-center bg-light mb-5 mx-auto" style={{ maxWidth: '40rem' }}>
          ...
          <Card.Body>
            ...
            <div className="d-flex flex-column mt-2">
              ...
              <Badge bg="white" className="p-4 fs-6 text-center d-flex justify-content-between align-items-center border border-secondary">
                <span className="text-dark">
                  Polulation
                  {' '}
                </span>
              ...
              <Badge bg="light" className="p-3 fs-6 text-center d-flex justify-content-between align-items-center border border-secondary">
                <span className="text-dark">
                  Critical
                  {' '}
                </span>
              ...
              <Badge bg="white" className="p-3 fs-6 text-center d-flex justify-content-between align-items-center border border-secondary">
                <span className="text-dark">
                  Total Cases
                  {' '}
                </span>
